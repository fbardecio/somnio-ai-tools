...
- `agent-rules/rules/python/testing-unit.md`
- `agent-rules/rules/python/testing-integration.md`
...
INSTRUCTIONS:
1. USE the `Read` tool to read both local standards files listed above.
